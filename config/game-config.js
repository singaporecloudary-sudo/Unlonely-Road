...
const GameConfig = {
  ...
  crafting: {
    ...
    vehicleTable: [
      ...
      [ 1,   80,   8, 1,     1,  1,  1,  100,       1],
      [ 2,  100,  10, 1,   2.5,  4,  1,  1500,      2],
      [ 3,  120,   8, 2,     6,  5,  1,  4725,      2],
      [ 4,  150,  10, 2,    15,  6,  1,  14883,     3],
      [ 5,  180,  11, 2,    35,  7,  1,  46883,     3],
      // LV6-10：成长期，承伤 ~8-10次，DPS 73→150
      [ 6,  220,  11, 2,    80,  8,  1,  147684,    4],
      [ 7,  260,  10, 3,   180,  9,  2,  465204,    4],
      [ 8,  300,  12, 3,   400, 10,  2,  1465394,   5],
      [ 9,  340,  10, 4,   900, 11,  3,  4615992,   5],
      [10,  380,  12, 4,  2000, 12,  3,  14540377,  6],
